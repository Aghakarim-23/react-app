...
const Header = () => {
  ...
  return (
    <div className='border-2 py-2 fixed top-0 left-0 z-50 w-full h-[4rem] bg-white'>
        ...
        <h1 className='h-[3rem] flex justify-center items-center text-4xl bg-gradient-to-r from-orange-500 to-red-600 text-transparent bg-clip-text' style={scrollFromRightStyle}>Saytımıza xoş gəlmişsiniz</h1>
    </div>
  )
}

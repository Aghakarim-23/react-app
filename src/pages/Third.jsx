...
const Third = () => {
  return (
    <div className="h-screen text-white  bg-green-800  flex flex-col gap-12 w-full items-center justify-center">
    <h2 className="text-5xl tracking-widest">Sonuncu səhifə</h2>
    <p className="p-12">
